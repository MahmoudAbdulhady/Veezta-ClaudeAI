...
namespace Infrastrucutre.Repositories
{
    public class DoctorRepository : IDoctorRepository
    {
        ...
        /// <summary>
        /// Resolves a Doctor table primary key from an Identity user ID.
        /// Used by the controller to derive doctorId from a JWT claim.
        /// </summary>
        public async Task<int?> GetDoctorIdByUserIdAsync(string userId)
        {
            var doctor = await _veeztaDbContext.Doctors
